...
const DevInfo = () => {
  return (
    <div className="testimonial-section py-8">
          ...
          <div>
            <div className="">
              <div className="flex justify-center items-center ">
                <h3 className="py-2 text-black text-2xl inline-block text-center w-80 rounded-sm font-semibold">
                  About Me
                </h3>
              </div>
            </div>
            ...
            <p className="text-base leading-7 font-medium text-gray-900 text-justify my-3">
              ...
              modern frontend technologies to build visually stunning and highly
              functional web applications. Passionate about pushing the
              boundaries of web development to create engaging digital
              experiences.
            </p>
            <div className="flex gap-20 my-8">
              <div className="flex flex-col">
                <h3 className="py-1  text-gray-700  text-2xl inline-block text-center rounded-sm font-semibold">
                  Education
                </h3>
