const BuyCoin = () => {
  return (
    <div>
      <div className="flex min-h-screen items-center justify-center bg-slate-200 dark:bg-gray-800">
              ...
              <div className="w-72 max-w-xl rounded-md bg-white dark:bg-gray-900 p-5 text-gray-600 dark:text-gray-300 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-end justify-between">
                    <p>
                      <span className="text-lg font-bold">12 GB</span> of
                      storage
                    </p>
            ...
            <label className="cursor-pointer">
              ...
              <div className="w-72 max-w-xl rounded-md bg-white dark:bg-gray-900 p-5 text-gray-600 dark:text-gray-300 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-end justify-between">
                    <p>
                      <span className="text-lg font-bold">50 GB</span> of
                      storage
                    </p>
            ...
            <label className="cursor-pointer">
              ...
              <div className="w-72 max-w-xl rounded-md bg-white dark:bg-gray-900 p-5 text-gray-600 dark:text-gray-300 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-end justify-between">
                    <p>
                      <span className="text-lg font-bold">100 GB</span> of
                      storage
                    </p>
